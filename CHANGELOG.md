...
## 0.3.8 — 2026-08-30
- Put "About Cardinal", "Check for Updates…" and "Settings" on the menu-bar icon. Turning that icon on switches the app to macOS's Accessory policy, which by design removes the Dock icon *and* the app's own menu bar — so with it enabled there was nowhere left to read which version was running.
